...
My initial version was highly sensitive to my process model noise, which I tuned to the thousandth
decimal place to be able to pass all tests. That's indicative that version was flawed.
...
be improved with techniques like simulated annealing, but that's for another time...
